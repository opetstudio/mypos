...
const mapStateToProps = (state, ownProps) => {
  ...
  const dataDetail = ClassparticipantSelectors.getDetailById(state.classparticipant, id)
  ...
  return {
    ...
    dataDetail,
    submitFailed: ClassparticipantSelectors.getFormSubmitFailed(state.classparticipant),
    submitSuccess: ClassparticipantSelectors.getFormSubmitSuccess(state.classparticipant),
    submit: ClassparticipantSelectors.getFormSubmit(state.classparticipant),
    submitMessage: ClassparticipantSelectors.getFormSubmitMessage(state.classparticipant),
    newRecordId: ClassparticipantSelectors.getNewRecordId(state.classparticipant),
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    setFormValue: (data) => dispatch(ClassparticipantActions.classparticipantSetFormValue(data)),
    formReset: (data) => dispatch(ClassparticipantActions.classparticipantFormReset(data)),
    fetchOne: (query) => dispatch(ClassparticipantActions.classparticipantRequest(query)),
    entityCreate: (data) => dispatch(ClassparticipantActions.classparticipantCreate(data)),
    entityUpdate: (data, id) => dispatch(ClassparticipantActions.classparticipantUpdate(data, id))
