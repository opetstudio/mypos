...
const mapStateToProps = (state, ownProps) => {
  ...
  const allDataArr = ClassparticipantSelectors.getAllDataArr(state.classparticipant)
  ...
  return {
    ...
    defaultPageSize,
    column,
    maxModifiedon: ClassparticipantSelectors.getMaxModifiedon(state.classparticipant),
    allDataArr,
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    fetchAll: (query) => dispatch(ClassparticipantActions.classparticipantRequestAll(query)),
    deleteRow: (query) => dispatch(ClassparticipantActions.classparticipantDeleteSuccess(query)),
    updateOne: (data, id) => dispatch(ClassparticipantActions.classparticipantUpdate(data, id)),
    removeOne: (data, id) => dispatch(ClassparticipantActions.classparticipantRemove(data, id)),
    updateBatch: (data) => dispatch(ClassparticipantActions.classparticipantUpdateBatch(data))
  }
}
