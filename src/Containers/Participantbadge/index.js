...
const mapStateToProps = (state, ownProps) => {
  ...
  const allDataArr = ParticipantbadgeSelectors.getAllDataArr(state.participantbadge)
  ...
  return {
    ...
    defaultPageSize,
    column,
    maxModifiedon: ParticipantbadgeSelectors.getMaxModifiedon(state.participantbadge),
    allDataArr,
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    fetchAll: (query) => dispatch(ParticipantbadgeActions.participantbadgeRequestAll(query)),
    deleteRow: (query) => dispatch(ParticipantbadgeActions.participantbadgeDeleteSuccess(query)),
    updateOne: (data, id) => dispatch(ParticipantbadgeActions.participantbadgeUpdate(data, id)),
    removeOne: (data, id) => dispatch(ParticipantbadgeActions.participantbadgeRemove(data, id)),
    updateBatch: (data) => dispatch(ParticipantbadgeActions.participantbadgeUpdateBatch(data))
  }
}
