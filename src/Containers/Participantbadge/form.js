...
const mapStateToProps = (state, ownProps) => {
  ...
  const dataDetail = ParticipantbadgeSelectors.getDetailById(state.participantbadge, id)
  ...
  return {
    ...
    dataDetail,
    submitFailed: ParticipantbadgeSelectors.getFormSubmitFailed(state.participantbadge),
    submitSuccess: ParticipantbadgeSelectors.getFormSubmitSuccess(state.participantbadge),
    submit: ParticipantbadgeSelectors.getFormSubmit(state.participantbadge),
    submitMessage: ParticipantbadgeSelectors.getFormSubmitMessage(state.participantbadge),
    newRecordId: ParticipantbadgeSelectors.getNewRecordId(state.participantbadge),
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    setFormValue: (data) => dispatch(ParticipantbadgeActions.participantbadgeSetFormValue(data)),
    formReset: (data) => dispatch(ParticipantbadgeActions.participantbadgeFormReset(data)),
    fetchOne: (query) => dispatch(ParticipantbadgeActions.participantbadgeRequest(query)),
    entityCreate: (data) => dispatch(ParticipantbadgeActions.participantbadgeCreate(data)),
    entityUpdate: (data, id) => dispatch(ParticipantbadgeActions.participantbadgeUpdate(data, id))
