...
module.exports[`set_init`] = function (DB) {
  let setInitialData = (initData) => {
    ...
    const storage = DB.pointofsale
    let schema = erevnaServices.model.pointofsale.schema
    ...
    initData.forEach((v, k) => {
      let dataCreate = erevnaServices.model.pointofsale.convertToSchemaForCreate(v) || {}
  ...
  setInitialData([
    {
      'pointofsale_name': 'KASIR',
      'pointofsale_rank': 250,
      'status': 'publish'
    }
  ])
}
module.exports[`post_pointofsales`] = function (event, request, DB) {
}
module.exports[`get_pointofsales`] = function (event, request, DB) {
}
module.exports[`patch_pointofsales`] = function (event, request, DB) {
}